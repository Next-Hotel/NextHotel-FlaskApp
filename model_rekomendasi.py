...
# Processing
output_dataset = load_data("https://storage.googleapis.com/data-hotel/list-hotel/output_dataset.csv")
df = load_data("https://storage.googleapis.com/data-hotel/list-hotel/data_preprocessing.csv")
...
# def get_weight():
test = pd.read_json(json.dumps({"interest": ["Transportation", "Connectivity", "Shuttle Service"]}))
test = test['interest']
weights = []
